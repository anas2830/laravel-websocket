...
<div class="page-header">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{route('provider.batch.index')}}">Assign Batche</a></li>
...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Assign Batche Update</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.batch.update', [$assign_batch->id])}}" method="POST">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="batch_no" class="form-control" placeholder="Batch Name" value="{{$assign_batch->batch_no}}" placeholder="Batch No-01">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="select-search" name="course_id" required="">
                                ...
                                <option value="{{$course->id}}" @if ($course->id == $assign_batch->course_id) selected @endif>{{$course->course_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="date" class="form-control" name="start_date" required="" value="{{$assign_batch->start_date}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="time" class="form-control" name="start_time" required="" value="{{$assign_batch->start_time}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">Batch Fb url</label>
                        <div class="col-lg-10">
                            <textarea name="batch_fb_url" class="form-control">{{$assign_batch->batch_fb_url}}</textarea>
                        </div>
                    </div>
                    <!-- /basic text input -->
                </fieldset>
