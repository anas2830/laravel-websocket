        ...
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list" style="margin-top: 0px">
                    <li style="margin-right: 10px;"><a href="{{route('provider.widget.create')}}" class="btn btn-primary add-new">Add New</a></li>
                ...
                @if (!empty($all_widgets))
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('provider.widget.edit', [$widget->id])}}" class="action-icon"><i class="icon-pencil7"></i></a>
                            <a href="#" class="action-icon"><i class="icon-trash" id="delete" delete-link="{{route('provider.widget.destroy', [$widget->id])}}">@csrf </i></a>
                        </td>
                    </tr> 
                    @endforeach
                @else
