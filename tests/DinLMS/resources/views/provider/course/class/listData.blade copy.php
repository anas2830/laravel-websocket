...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <table class="table table-bordered table-hover datatable-highlight data-list" id="courseClassListTable">
            <thead>
                <tr>
                    <th width="5%">SL.</th>
...
<script type="text/javascript">
    // $('#courseClassTable').DataTable();
    $('#courseClassListTable').DataTable({
        dom: 'lBfrtip',
            "iDisplayLength": 10,
