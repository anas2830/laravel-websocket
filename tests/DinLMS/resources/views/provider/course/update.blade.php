            ...
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.course.update', [$course->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">Course Name <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" name="course_name" value="{{$course->course_name}}" class="form-control" required="required" placeholder="Course Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-3">Course Overview <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <textarea id="course_overview" name="course_overview" class="form-control" required="required">{{$course->course_overview}}</textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
                    ...
                    <!-- Image input -->
                    <div class="form-group">
                        <label class="col-lg-3 control-label text-semibold">Course Thumb</label>
                        <div class="col-lg-6">
