...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Support Create</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.support.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="content-group">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="{{Helper::generateAutoID('edu_supports','support_id')}}" disabled>
                            <input type="hidden" name="support_id" value="{{Helper::generateAutoID('edu_supports','support_id')}}">
                        </div>
                    </div> --}}
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="email" id="email_address" name="email" class="form-control" placeholder="Email" required>
                        </div>
                    </div>
                    <div class="form-group">
