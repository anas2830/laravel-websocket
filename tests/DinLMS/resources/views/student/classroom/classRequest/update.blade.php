...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list" style="margin-top: 0px">
                    <li style="margin-right: 10px;"><a href="{{route('requestClass.create')}}" class="btn btn-primary add-new">Take Support</a></li>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('requestClass.update', [$request_info->id])}}" method="POST">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="select-search" name="assign_batch_class_id" required="">
                                ...
                                <option value="{{$class->id}}" @if($class->id == $request_info->assign_batch_class_id) selected @endif>{{$class->class_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea name="request_reasons" id="request_reasons" class="form-control" required>
                                {!! $request_info->request_reasons !!}
                            </textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
