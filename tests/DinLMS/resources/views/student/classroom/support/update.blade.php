...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('takeSupport.update', [$request_info->id])}}" method="POST">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select class="select-search" name="category_id" required="">
                                ...
                                <option value="{{$category->id}}" @if($category->id == $request_info->category_id) selected @endif >{{$category->category_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="request_title" value="{{$request_info->request_title}}" class="form-control" placeholder="enter support title" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-3">Details <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <textarea name="request_details" id="reqDetails" class="form-control" required>
