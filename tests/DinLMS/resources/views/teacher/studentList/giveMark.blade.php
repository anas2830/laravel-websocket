...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Assignment Marking</h5>
            <div class="heading-elements">
                <ul class="icons-list">
                    <li style="margin-right: 10px;"><a href="{{route('teacher.batchstuStudentList', ['assignment_id'=>$submission_info->assignment_id, 'type' =>1])}}" class="btn btn-info add-new"><i class="icon-point-left mr-10"></i>Go To Student List</a></li>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('teacher.batchstuStudentGiveMarkSave')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('teacher.batchstuStudentList', ['assignment_id'=>$submission_info->assignment_id,'type' =>1])}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
