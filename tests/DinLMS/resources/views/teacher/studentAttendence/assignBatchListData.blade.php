...
<div class="page-header">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{route('teacher.batchstuAttendence')}}">Assign Batch</a></li>
                ...
                @if (!empty($assign_batches))
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('teacher.batchstuClassList', [$assign_batch->id])}}" class="btn btn-primary">Class List <i class="icon-circle-right2 position-right"></i></a>
                        </td>
                    </tr> 
                    @endforeach
                @else
