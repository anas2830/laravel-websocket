...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('teacher.batchstuAssignments.update',[$assignment_info->id])}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="select-search" name="assignment_archive_id" required="">
                                ...
                                <option value="{{$assignment->id}}" @if ($assignment_info->assignment_archive_id == $assignment->id) selected @endif>{{$assignment->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="date" class="form-control" name="due_date" required="" value="{{$assignment_info->due_date}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                        <input type="time" class="form-control" name="due_time" required="" value="{{$assignment_info->due_time}}">
                        </div>
                    </div>
                    <!-- /basic textarea -->
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('teacher.batchstuAssignments.index', ['batch_class_id'=>$assignment_info->assign_batch_class_id])}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
